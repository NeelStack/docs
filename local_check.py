...
# 1. Clean remaining legacy files if clean_remaining.py exists
if os.path.exists("clean_remaining.py"):
    print("Executing legacy file cleanup...")
    try:
        import clean_remaining
...
# 2. Run local document structure validation
